...
import { renderNavLinks } from "./Navlink";
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <div className="sm:hidden">
            ...
            >
              <Bars3Icon className="hs-collapse-open:hidden flex-shrink-0 w-4 h-4" />
              <XMarkIcon className="hs-collapse-open:block hidden flex-shrink-0 w-4 h-4" />
            </button>
          </div>
        </div>
        <div
